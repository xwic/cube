...
public class CubeImportUtil {
	 ...
	 * @throws ETLException 
	 */
	public static int importCSV(InputStream in, ICube cube) throws IOException, ImportException {
	
		return new CubeImportUtil()._importCSV(in, cube, false);
	 ...
	 * @throws ETLException 
	 */
	public static int importCSV(InputStream in, ICube cube, boolean autoCreate) throws IOException, ImportException {
	
		return new CubeImportUtil()._importCSV(in, cube, autoCreate);
	 ...
	 * @throws ETLException 
	 */
	private int _importCSV(InputStream in, ICube cube, boolean autoCreate) throws IOException, ImportException {
